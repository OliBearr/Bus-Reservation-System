        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form action="{{ route('booking.confirm') }}" method="POST">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    {{-- LEFT COLUMN: FORMS (Contact & Passengers) --}}
                    <div class="lg:col-span-2 space-y-8">
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" id="mobile_number" placeholder="+63 9XX XXX XXXX" required name="contact_phone" class="w-full rounded-lg border-gray-300 focus:ring-[#001233]">
                                    <script>
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                            ...
                            <p class="text-xs text-gray-400 mb-6">These details will be used for both trips.</p>
                                ...
                                <div class="mb-6 border-b border-gray-100 pb-4 last:border-0">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="text" name="passengers[{{ $i }}][first_name]" class="w-full rounded-lg border-gray-300 focus:border-[#001233] focus:ring-[#001233]" required>
                                            <input type="hidden" name="passengers[{{ $i }}][type]" value="adult">
                                            {{-- Assign seats for both trips if available --}}
                                        ...
                                        <div>
                                            ...
                                            <input type="text" name="passengers[{{ $i }}][surname]" class="w-full rounded-lg border-gray-300 focus:border-[#001233] focus:ring-[#001233]" required>
                                        </div>
                                    </div>
                                    <div class="mt-3">
                            ...
                            @for ($j = 0; $j < $request->passengers_child; $j++)
                                <div class="mb-6 border-b border-gray-100 pb-4 last:border-0">
                                    <h4 class="text-sm font-bold text-green-600 uppercase mb-3 flex justify-between items-center">
                                        ...
                                        <span class="text-[10px] bg-green-100 text-green-700 px-2 py-1 rounded-full">20% OFF</span>
                                    </h4>
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            <label class="block text-xs font-bold text-gray-500 uppercase mb-1">First Name</label>
                                            <input type="text" name="passengers[{{ $seatOffset + $j }}][first_name]" class="w-full rounded-lg border-gray-300 focus:border-[#001233] focus:ring-[#001233]" required>
                                        ...
                                        <div>
                                            <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Surname</label>
                                            <input type="text" name="passengers[{{ $seatOffset + $j }}][surname]" class="w-full rounded-lg border-gray-300 focus:border-[#001233] focus:ring-[#001233]" required>
                                        </div>
                                    </div>
                                </div>
                            @endfor
