<x-admin-layout>
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <a href="{{ route('admin.reservations.index') }}" class="inline-flex items-center text-sm text-gray-500 hover:text-[#001233] mb-6 transition">
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
            ...
            <div class="bg-[#001233] px-8 py-6 flex justify-between items-center text-white">
                <div>
                ...
                <div class="text-right">
                    <span class="bg-green-500 text-white px-4 py-1 rounded-full text-xs font-bold uppercase tracking-wider shadow-sm">
                        {{ $reservation->status }}
                    </span>
                </div>
            </div>
            ...
            <div class="p-8">
                <h3 class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-4">Passenger Information</h3>
