    ...
    <div class="min-h-screen flex">
        ...
        <aside class="w-64 bg-[#001233] text-white flex flex-col fixed h-full shadow-xl z-50">
            ...
            <nav class="flex-grow py-6 px-4 space-y-2 overflow-y-auto">
                ...
                <p class="px-4 text-xs font-bold text-gray-500 uppercase tracking-wider mt-6 mb-2">Management</p>

                <a href="{{ route('admin.buses.index') }}" class="flex items-center px-4 py-3 rounded-lg transition {{ request()->routeIs('admin.buses*') ? 'bg-blue-900 text-white shadow-md' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
                ...
                <a href="{{ route('admin.routes.index') }}" class="flex items-center px-4 py-3 rounded-lg transition {{ request()->routeIs('admin.routes*') ? 'bg-blue-900 text-white shadow-md' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                    Routes
                </a>

                <a href="{{ route('admin.schedules.index') }}" class="flex items-center px-4 py-3 rounded-lg transition {{ request()->routeIs('admin.schedules*') ? 'bg-blue-900 text-white shadow-md' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    Schedules
                </a>

                <a href="{{ route('admin.reservations.index') }}" class="flex items-center px-4 py-3 rounded-lg transition {{ request()->routeIs('admin.reservations*') ? 'bg-blue-900 text-white shadow-md' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
                ...
                <a href="{{ route('admin.cancellations.index') }}" 
                    class="flex items-center px-4 py-3 rounded-lg transition 
                            {{ request()->routeIs('admin.cancellations.index') ? 'bg-blue-900 text-white shadow-md' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
                ...
                <a href="{{ route('admin.verify') }}" 
                    class="flex items-center px-4 py-3 rounded-lg transition 
                            {{ request()->routeIs('admin.verify') ? 'bg-blue-900 text-white shadow-md' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
